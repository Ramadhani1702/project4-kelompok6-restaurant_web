<%-- 
    Document   : Success
    Created on : Jul 12, 2022, 2:11:24 PM
    Author     : Asus
--%>
...
<div class="content">
    <h1 id="opening">RESERVATION IS SUCCESSFULLLY!</h1>
    <a href="RajilRestaurant.jsp" class="btn">LOGOUT</a>
</div>
